"""
Database setup script for task_manager_07
...
Run this before starting the application:
    python task_manager_07/manage_db.py
"""
...
# "from task_manager_07.app import create_app" works
# regardless of which directory the script is run from.
sys.path.insert(0, str(Path(__file__).resolve().parent.parent))

from task_manager_07.app import create_app
from task_manager_07.database import db
from task_manager_07.models import Tag, Task, TaskTag, User
...
def setup_database():
    ...
    """
    print("Setting up task_manager_07 database...")
